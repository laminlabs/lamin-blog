...
<div style="display: flex; gap: 16px; align-items: flex-start;">
  <div style="flex: 1; min-width: 0;">
    ...
    <p><strong>Figure 1a (<a href="https://lamin.ai/laminlabs/lakehouse-benchmarks/artifact/kBOCwXvajOXJAniJ000L">source</a>)</strong>: Dataset 1: 4M rows, 3k files.</p>
  </div>
  <div style="flex: 1; min-width: 0;">
    <img src="https://lamin-site-assets.s3.amazonaws.com/.lamindb/Lf8f0LJY63quZ3n70002.svg" />
