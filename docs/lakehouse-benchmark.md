...
<svg viewBox="0 0 720 520" xmlns="http://www.w3.org/2000/svg" font-family="monospace, ui-monospace, SFMono-Regular" font-size="13">
  ...
  <text x="537" y="99" font-size="11" fill="#444">Metadata JSON</text>
  <rect x="520" y="108" width="12" height="12" rx="2" fill="#DD8452" opacity="0.85"/>
  <text x="537" y="119" font-size="11" fill="#444">Manifest list (.avro)</text>
  ...
  <rect x="98" y="125" width="10" height="10" rx="2" fill="#4C72B0" opacity="0.85"/>
  <text x="112" y="135" fill="#444">00000-0-098b4b22-5f1a-4435-acb8-ef3321675d44.parquet</text>
  <text x="112" y="147" fill="#999" font-size="10">242 KB · first write (8,929 rows)</text>

  <line x1="80" y1="160" x2="96" y2="160" stroke="#ccc" stroke-width="1.5"/>
  <rect x="98" y="150" width="10" height="10" rx="2" fill="#4C72B0" opacity="0.85"/>
  <text x="112" y="160" fill="#444">00000-0-27980d25-a692-4c42-ae48-3e75cc4b2cfd.parquet</text>
  <text x="112" y="172" fill="#999" font-size="10">242 KB · first write (8,929 rows)</text>

  <line x1="80" y1="185" x2="96" y2="185" stroke="#ccc" stroke-width="1.5"/>
  <rect x="98" y="175" width="10" height="10" rx="2" fill="#4C72B0" opacity="0.85"/>
  ...
  <text x="112" y="250" fill="#999" font-size="10">1.6 KB · schema at table creation</text>

  <line x1="80" y1="263" x2="96" y2="263" stroke="#ccc" stroke-width="1.5"/>
  <rect x="98" y="253" width="10" height="10" rx="2" fill="#55A868" opacity="0.85"/>
  <text x="112" y="263" fill="#444">00001-5beb7d3b-832e-4f82-9cdf-b7b74e32f231.metadata.json</text>
  <text x="112" y="275" fill="#999" font-size="10">2.5 KB · after first write (snapshot 1)</text>

  <line x1="80" y1="288" x2="96" y2="288" stroke="#ccc" stroke-width="1.5"/>
  <rect x="98" y="278" width="10" height="10" rx="2" fill="#55A868" opacity="0.85"/>
  <text x="112" y="288" fill="#444">00002-5ed09424-2c6e-40be-90e7-8a6832b1f28a.metadata.json</text>
  <text x="112" y="300" fill="#999" font-size="10">3.3 KB · after append (snapshot 2)</text>

  <line x1="80" y1="313" x2="96" y2="313" stroke="#ccc" stroke-width="1.5"/>
  <rect x="98" y="303" width="10" height="10" rx="2" fill="#55A868" opacity="0.85"/>
  ...
  <text x="112" y="352" fill="#999" font-size="10">5.5 KB · manifest list for snapshot 1</text>

  <line x1="80" y1="365" x2="96" y2="365" stroke="#ccc" stroke-width="1.5"/>
  <rect x="98" y="355" width="10" height="10" rx="2" fill="#DD8452" opacity="0.85"/>
  <text x="112" y="365" fill="#444">27980d25-a692…-m0.avro</text>
  <text x="112" y="377" fill="#999" font-size="10">5.5 KB · manifest list for snapshot 2</text>

  <line x1="80" y1="390" x2="96" y2="390" stroke="#ccc" stroke-width="1.5"/>
  <rect x="98" y="380" width="10" height="10" rx="2" fill="#DD8452" opacity="0.85"/>
